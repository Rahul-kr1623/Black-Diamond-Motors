...
import { Download, Truck, Hammer, Settings, ShieldCheck, ArrowRight, CheckCircle2, Ruler, Mountain } from "lucide-react";

// --- 1. MODEL VARIANT TABLE (From Booklet: ROCK BODY) ---
const modelTable = [
  { vol: "12 m³", overhang: "907", length: "7006", width: "2479", height: "2616", tipping: "52°", prime: "25 MT" },
  { vol: "14 m³", overhang: "907", length: "7006", width: "2479", height: "2791", tipping: "52°", prime: "25 MT" },
  { vol: "16 m³", overhang: "907", length: "7006", width: "2479", height: "2961", tipping: "52°", prime: "25 MT" },
];

// --- 2. COMPONENT SPECS (Specific to Rock Body) ---
const componentSpecs = [
  { label: "Application", value: "Mining, Heavy Rock, Aggregate, Coal." },
  { label: "Body Material", value: "All Welded Steel Construction (ST-52 or equivalent)." },
  { label: "Material Yield", value: "Min. Yield Strength 350 N/mm²." },
  { label: "Chassis Compatibility", value: "Optimized for 25 MT Mining Chassis." },
  { label: "Hydraulics", value: "HYVA / HYPRATEK Front End Cylinder with Air Control Valve." },
  { label: "Electricals", value: "24V System with LED side markers and reflectors." },
  { label: "Paint System", value: "Shot Blasted + Zinc Phosphate Primer + 2 Coats Auto Paint." },
  { label: "Accessories", value: "Mudguards and Rock Breakers (Optional)." },
];

// --- 3. FEATURES (Mining Focused) ---
const features = [
  { 
    title: "Mining Grade Build", 
    desc: "Engineered specifically for high-impact rock mining operations with reinforced body structure.",
    icon: <Mountain className="w-8 h-8 text-[#d11329]" />
  },
  { 
    title: "High Tipping Angle", 
    desc: "Designed with a 52° tipping angle for faster and complete discharge of heavy rocks.",
    icon: <Settings className="w-8 h-8 text-[#d11329]" />
  },
  { 
    title: "Wear Resistant", 
    desc: "Constructed using high-yield strength steel (ST-52) to resist abrasion and heavy impact.",
    icon: <ShieldCheck className="w-8 h-8 text-[#d11329]" />
  },
  { 
    title: "Heavy Duty Hydraulics", 
    desc: "Equipped with powerful front-end hydraulic cylinders to lift heavy rock loads effortlessly.",
    icon: <Hammer className="w-8 h-8 text-[#d11329]" />
  },
];

export default function RockBody() {
  return (
    <main className="bg-[#050505] text-white pt-20">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          {/* ✅ Placeholder: Replace with Rock Body Image */}
          <Image
            src="/products/rock-body-hero.png" 
            alt="Black Diamond Rock Body Tipper"
            fill
        ...
        <div className="relative z-10 text-center max-w-6xl px-4 md:px-6">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-oswald font-bold uppercase tracking-tight mb-6 drop-shadow-2xl text-white">
              Rock <span className="text-zinc-500">Body</span>
            </h1>
            <p className="text-lg md:text-2xl text-zinc-200 font-medium max-w-4xl mx-auto leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
              Heavy Duty Mining Solutions with <span className="text-[#d11329]">52° Tipping Angle</span>.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-oswald font-bold uppercase mb-8 leading-tight">
              Extreme <br /> <span className="text-[#d11329]">Durability</span>
            </h2>
            <div className="space-y-6 text-zinc-400 text-lg leading-relaxed text-justify font-roboto">
              <p>
                A <strong>Rock Body</strong> tipper is specifically designed for the harshest environments. Unlike standard box tippers, our Rock Bodies are reinforced to handle high-impact loads from large boulders and heavy ores during mining excavation.
              </p>
              <p>
                Featuring a steep <strong>52° Tipping Angle</strong>, these bodies ensure quick and clean discharge of materials. Constructed with high-yield <strong>ST-52 Steel</strong>, they offer superior resistance to wear and tear, making them the ideal choice for deep mining operations.
              </p>
              
              <div className="flex flex-col gap-4 mt-6">
                <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-6 h-6 text-[#d11329] shrink-0" />
                    <span className="text-white text-lg">Capacity: 12 Cu.m to 16 Cu.m (Mining Specific)</span>
                </div>
                <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-6 h-6 text-[#d11329] shrink-0" />
                    <span className="text-white text-lg">Compatible with 25 MT Mining Chassis</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
             ...
             <Image 
                 src="/products/rock-body.png" // ⚠️ Save booklet blueprint here
                 alt="Rock Body Engineering Blueprint"
                 fill
      ...
      <section className="py-24 bg-[#0a0a0a] border-y border-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 mt-4">Based on 25 MT Mining Chassis</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-zinc-900 text-[#d11329] text-base uppercase tracking-wider font-oswald">
                  ...
                  <th className="p-6 border-b border-zinc-800">Rear Overhang</th>
                  ...
                  <th className="p-6 border-b border-zinc-800">Tipping Angle</th>
                </tr>
              </thead>
              <tbody className="text-zinc-300 font-roboto text-sm md:text-base">
                {modelTable.map((row, i) => (
                  <tr key={i} className="border-b border-zinc-800 hover:bg-zinc-800/50 transition-colors odd:bg-black even:bg-[#0c0c0c]">
                    ...
                    <td className="p-6 border-r border-zinc-800">{row.overhang} mm</td>
                    ...
                    <td className="p-6 text-[#d11329] font-bold">{row.tipping}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            {modelTable.map((row, i) => (
              <div key={i} className="bg-[#111] border border-zinc-800 p-5 rounded-sm shadow-md">
                ...
                <div className="grid grid-cols-2 gap-y-2 text-sm text-zinc-400">
                  <div>Overhang: <span className="text-white">{row.overhang} mm</span></div>
        ...
        <div className="bg-[#d11329] rounded-sm p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-lg md:text-xl mb-10 max-w-3xl mx-auto">
              Get maximum durability and reliability for your mining operations with our Rock Bodies.
            </p>
