...
import { Download, Truck, Hammer, Settings, ShieldCheck, ArrowRight, CheckCircle2, Ruler, Car } from "lucide-react";

// --- 1. MODEL VARIANT TABLE (From Booklet) ---
const modelTable = [
  { type: "Chassis Carrier", length: "18750 mm", width: "2600 mm", height: "Standard", capacity: "Truck Chassis / Tractors / JCB", feature: "Manual Loading Ramp" },
  { type: "Car Carrier (8 Cars)", length: "18750 mm", width: "2600 mm", height: "3975 mm", capacity: "8 Cars / Bikes", feature: "Double Deck System" },
  { type: "Car Carrier (10 Cars)", length: "18750 mm", width: "2600 mm", height: "3975 mm", capacity: "10 Small Cars", feature: "Maximized Storage" },
];

// --- 2. COMPONENT SPECS (Specific to Car Carrier) ---
const componentSpecs = [
  { label: "Application", value: "Transportation of Cars, SUVs, Bikes, Truck Chassis, Tractors." },
  { label: "Deck System", value: "Hydraulically operated upper deck for multi-level loading." },
  { label: "Hydraulics", value: "Reputed make Hydraulics with Oil Tank & Control Valve." },
  { label: "Chassis Frame", value: "2 fabricated 'I' sections with welded cross members." },
  ...
  { label: "Loading Ramp", value: "Manual / Hydraulic Loading Ramp & Landing Legs." },
...
const features = [
  { 
    ...
    desc: "Designed to carry a versatile mix of vehicles including cars, SUVs, tractors, and truck chassis efficiently.",
    icon: <Car className="w-8 h-8 text-[#d11329]" />
  },
  { 
    title: "Hydraulic Deck", 
    desc: "Features an advanced hydraulic upper deck system to maximize load capacity without compromising safety.",
    icon: <Settings className="w-8 h-8 text-[#d11329]" />
  },
  { 
    title: "Extended Length", 
    desc: "With an overall length of 18.75 meters, it provides ample space for bulk vehicle logistics.",
    icon: <Ruler className="w-8 h-8 text-[#d11329]" />
  },
  { 
    title: "Secure Loading", 
    desc: "Equipped with manual loading ramps and secure lashing points to ensure safe transit of premium vehicles.",
    icon: <ShieldCheck className="w-8 h-8 text-[#d11329]" />
  },
];

export default function CarCarrier() {
  return (
    <main className="bg-[#050505] text-white pt-20">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          {/* ✅ Placeholder: Replace with Car Carrier Image */}
          <Image
            src="/products/car-carrier-hero.png" 
            alt="Black Diamond Car Carrier"
            fill
        ...
        <div className="relative z-10 text-center max-w-6xl px-4 md:px-6">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-oswald font-bold uppercase tracking-tight mb-6 drop-shadow-2xl text-white">
              Car & Chassis <span className="text-zinc-500">Carrier</span>
            </h1>
            <p className="text-lg md:text-2xl text-zinc-200 font-medium max-w-4xl mx-auto leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
              Engineered for <span className="text-[#d11329]">Automobile Transport</span> at Scale.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-oswald font-bold uppercase mb-8 leading-tight">
              Specialized <br /> <span className="text-[#d11329]">Auto Logistics</span>
            </h2>
            <div className="space-y-6 text-zinc-400 text-lg leading-relaxed text-justify font-roboto">
              <p>
                The <strong>Chassis & Car Carrier</strong> is a specialized semi-trailer designed for the safe and efficient transportation of automobiles. From heavy commercial vehicle chassis to passenger cars and two-wheelers, our carriers are engineered to maximize load per trip while ensuring vehicle safety.
              </p>
              <p>
                Built with a robust steel structure and advanced hydraulic systems, these trailers allow for double-deck loading, significantly increasing transport efficiency. Whether for OEM logistics or inter-state transport, Black Diamond Motors delivers reliability.
              </p>
              
              <div className="flex flex-col gap-4 mt-6">
                <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-6 h-6 text-[#d11329] shrink-0" />
                    <span className="text-white text-lg">Capacity: Up to 10 Cars or Heavy Chassis</span>
                </div>
                <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-6 h-6 text-[#d11329] shrink-0" />
                    <span className="text-white text-lg">Length: 18.75 Meters (Maximum Utility)</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
             ...
             <Image 
                 src="/products/car-carrier.png" // ⚠️ Save booklet blueprint here
                 alt="Car Carrier Engineering Blueprint"
                 fill
      ...
      <section className="py-24 bg-[#0a0a0a] border-y border-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 mt-4">Standard Models (Custom Configuration Available)</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-zinc-900 text-[#d11329] text-base uppercase tracking-wider font-oswald">
                  <th className="p-6 border-b border-zinc-800">Variant</th>
                  ...
                  <th className="p-6 border-b border-zinc-800">Capacity</th>
              ...
              <tbody className="text-zinc-300 font-roboto text-sm md:text-base">
                {modelTable.map((row, i) => (
                  <tr key={i} className="border-b border-zinc-800 hover:bg-zinc-800/50 transition-colors odd:bg-black even:bg-[#0c0c0c]">
                    ...
                    <td className="p-6 border-r border-zinc-800">{row.capacity}</td>
                    <td className="p-6 text-[#d11329] font-bold">{row.feature}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            {modelTable.map((row, i) => (
              <div key={i} className="bg-[#111] border border-zinc-800 p-5 rounded-sm shadow-md">
                <div className="flex justify-between items-center mb-3 border-b border-zinc-800 pb-2">
                  ...
                  <span className="text-xs font-bold bg-zinc-800 text-white px-2 py-1 rounded">{row.feature}</span>
                </div>
                <div className="grid grid-cols-2 gap-y-2 text-sm text-zinc-400">
                  <div>Length: <span className="text-white">{row.length}</span></div>
                  <div>Capacity: <span className="text-white">{row.capacity}</span></div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-[#d11329] rounded-sm p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-lg md:text-xl mb-10 max-w-3xl mx-auto">
              Get the best price for India's most efficient Chassis & Car Carriers.
            </p>
